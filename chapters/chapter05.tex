  ...
  \chapter{Lighting and Shading}
      ...
      \subsection{Colour Sources}
        ...
        \begin{descriptenum}
          ...
          \item[Distant Light] If the light source is far from the surface, the vector
            ...
            Also known as a \concept{directional light}, \concept{infinite light},
            or \concept{parallel light}.
    ...
    \section{Global Illumination}
      ...
      \begin{definition}{Ray Tracing (Path Tracing)}
        \concept{Ray tracing} starts with the synthetic-camera model but determines,
      ...
      \begin{definition}{Radiosity}
        A \concept{radiosity} renderer is based upon energy considerations.
    ...
    \section{Shadows}
      ...
      \begin{definition}{Shadow Mapping}
        ...
        depth information (a \concept{shadow map}) in a texture or buffer.
