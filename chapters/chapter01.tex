...
\begin{document}
  \chapter{Graphics Systems and Models}
    ...
    \section{A Graphics System}
      ...
      \subsection{Output Devices}
        ...
        \begin{wrapfigure}{l}{0.4\textwidth}
          \begin{center}
            \includegraphics[width=0.38\textwidth]{\main/images/chapter01/flat_panel_display.jpg}
          \end{center}
        ...
        \begin{definition}{Light}
          ...
          \begin{center}
            \begin{itemize*}[itemjoin=\quad, label={ }]
              \item \concept{450 nm} blue
              \item \concept{520 nm} green
              \item \concept{650 nm} red
            \end{itemize*}
          \end{center}
        \end{definition}
    ...
    \section{Programmable Pipelines}
      \concept{Programmable pipelines} refer to a graphics rendering pipeline where various stages
      ...
      \begin{sidenote}{Stages in a Programmable Graphics Pipeline}
        ...
        \begin{descriptenum}[nosep]
          ...
          \item[Primitive Assembly/Rasterization Stage] Individual primitives are assembled
            ...
            \concept{Rasterization} involves determining which fragments correspond to pixels
    ...
    \section{OpenGL Versions and WebGL}
      \begin{sidenote}{History of OpenGL}
        ...
        \concept{Version~2.0} (2004) introduced the \concept{OpenGL Shading Language},
        ...
        and \concept{retained mode graphics} became increasingly more important.
        \concept{Version~2.1} was released in 2006.

        Until \concept{Version~3.0} (2008),
        all versions of OpenGL were backwards compatible.
        From \concept{Version~3.1},
        backward compatibility would no longer be provided,
        and immediate mode was to be deprecated.

        We are currently at \concept{Version~4.4}.
      \end{sidenote}
      ...
      \begin{definition}{OpenGL ES}
        ...
        \concept{OpenGL~ES~1.1} (2008) was based on OpenGL~Version~1.5.\\
        \concept{OpenGL~ES~2.0} is based on OpenGL~Version~2.0,
        and supports only shader-based applications and not immediate mode.\\
        \concept{OpenGL~ES~3.0} was released in 2013.
      \end{definition}
      ...
      \concept{WebGL} is a JavaScript interface to OpenGL~ES 2.0
    ...
    \section{3D vs 2D}
      \concept{3D computer graphics} refers to the creation, manipulation, and rendering
