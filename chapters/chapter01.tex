	...
	\chapter{Graphics Systems and Models}
		...
		\section{A Graphics System}
			...
			\subsection{The CPU and GPU}
				...
				Nowadays, virtually all graphics systems are characterised by special purpose
			...
			\subsection{Output Devices}
				...
				All of the technologies available -- including light-emitting diodes (LEDs),
				liquid-crystal displays (LCDs), and plasma panels --
				use a two-dimensional grid to address inidividual light-emitting elements.
				\pagebreak
